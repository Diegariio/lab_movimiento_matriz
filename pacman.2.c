...
void colocar_x(char matriz[10][10]);
    ...
    for(i = 0;i < 10; i++ ){
        for (j = 0; j < 10; j++){
            if(matriz[i][j] == '*'){
                wherefila = i;
                wherecolumna = j;
                if(matriz[wherefila][wherecolumna - 1] == 'X'){
                    reinicio = 1;
                    matriz[wherefila][wherecolumna - 1] = 32;
                }else{
                    reinicio = 0;
                }
                matriz[i][j] = 32;
...
if (caracter == 'w' || caracter == 'W'){
    for(i = 0;i < 10; i++ ){
        for (j = 0; j < 10; j++){
            if(matriz[i][j] == '*'){
                wherefila = i;
                wherecolumna = j;
                if(matriz[wherefila - 1][wherecolumna] == 'X'){
                    reinicio = 1;
                    matriz[wherefila - 1][wherecolumna] = 32;
                }else{
                    reinicio = 0;
                }
                matriz[i][j] = 32;
    ...
    if (bandera == 1){
    printf("\n \n \t \t te demoraste %d movimientos en recolectar las O\n",contador);
    printf("\n \n \t \t GANASTE MI LOCO!!!\n\n");
        break;
    }
}
